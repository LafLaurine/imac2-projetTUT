...
LIST_LABELS_DF = [LABEL_REAL[1], LABEL_DF[1]]
LIST_LABELS_F2F = [LABEL_REAL[1], LABEL_F2F[1]]
LIST_LABELS_FACESWAP = [LABEL_REAL[1], LABEL_FACESWAP[1]]
LIST_LABELS_MULTICLASS = [LABEL_REAL[1], LABEL_DF[1], LABEL_F2F[1], LABEL_FACESWAP[1]]
...
def match_labels_dict(dict_labels_found, dict_labels_expected):
    for (key, value) in dict_labels_expected.items():
        ...
        dict_labels_found[key] = dict_labels_expected[key]
